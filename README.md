...
* Need add pulldown for the Universal Inputs all programmed with raw value no unit of measure. The universal inputs have a large list of configurable UOM's of their own.
